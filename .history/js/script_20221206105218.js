window.addEventListener('DOMContentLoaded', function(){
    ...
    class NewsCard
    {
        constructor(date_time, h4, h6, a, img, alt, parentSelector, ...classes)
        {
    ...
    getResource('http://localhost:3000/news').then(data => {
        data.forEach(({date_time, h4, h6, a, img, alt}) => {
            new NewsCard(date_time, h4, h6, a, img, alt, '.section__news .news').render();
        });
    });
});